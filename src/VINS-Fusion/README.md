...
### 3.1 运行局部定位  
rosrun vins vins_node /home/robotcatkin_ws/src/VINS-Fusion/config/realsense/realsense_depth_imu_config.yaml

### 3.2 运行全局定位与稠密建图  
rosrun loop_fusion loop_fusion_node  /home/robotcatkin_ws/src/VINS-Fusion/config/realsense/realsense_depth_imu_config.yaml
